 ...
 */
public class PublishedPerformedOperationDynamicParam {
    ...
    @OraName(value = "performedv")
    @InitOrder(value = "4")
    @DataType(value = TransformType.LONG)
    public Long performedOperation_DPL_id;

    @DataType(value = TransformType.PARTITION)
    @PartForField(value = "performedOperation_DPL_id")
    @Default(value = "0")
    public Long performedOperation_DPL_colocationKey;

    @DataType(value = TransformType.ROOT)
    @PartForField(value = "performedOperation_DPL_id")
    @Default(value = "0")
    public Long performedOperation_DPL_rootId;
