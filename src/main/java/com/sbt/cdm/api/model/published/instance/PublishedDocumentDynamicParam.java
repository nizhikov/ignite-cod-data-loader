 ...
 */
public class PublishedDocumentDynamicParam {
    ...
    @OraName(value = "document")
    @InitOrder(value = "4")
    @DataType(value = TransformType.LONG)
    public Long document_DPL_id;

    @DataType(value = TransformType.PARTITION)
    @PartForField(value = "document_DPL_id")
    @Default(value = "0")
    public Long document_DPL_colocationKey;

    @DataType(value = TransformType.ROOT)
    @PartForField(value = "document_DPL_id")
    @Default(value = "0")
    public Long document_DPL_rootId;
