 ...
 */
public class PublishedAccessToolDynamicParam {
    ...
    @OraName(value = "accessTool")
    @InitOrder(value = "4")
    @DataType(value = TransformType.LONG)
    public Long accessTool_DPL_id;

    @DataType(value = TransformType.PARTITION)
    @PartForField(value = "accessTool_DPL_id")
    @Default(value = "0")
    public Long accessTool_DPL_colocationKey;

    @DataType(value = TransformType.ROOT)
    @PartForField(value = "accessTool_DPL_id")
    @Default(value = "0")
    public Long accessTool_DPL_rootId;
