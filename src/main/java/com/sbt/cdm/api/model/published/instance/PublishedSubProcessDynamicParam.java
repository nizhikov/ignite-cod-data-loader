 ...
 */
public class PublishedSubProcessDynamicParam {
    ...
    @OraName(value = "subProcess")
    @InitOrder(value = "4")
    @DataType(value = TransformType.LONG)
    public Long subProcess_DPL_id;

    @DataType(value = TransformType.PARTITION)
    @PartForField(value = "subProcess_DPL_id")
    @Default(value = "0")
    public Long subProcess_DPL_colocationKey;

    @DataType(value = TransformType.ROOT)
    @PartForField(value = "subProcess_DPL_id")
    @Default(value = "0")
    public Long subProcess_DPL_rootId;
