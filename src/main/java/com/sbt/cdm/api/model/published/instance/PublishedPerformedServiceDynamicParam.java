 ...
 */
public class PublishedPerformedServiceDynamicParam {
    ...
    @InitOrder(value = "4")
    @DataType(value = TransformType.LONG)
    public Long performedService_DPL_id;

    @DataType(value = TransformType.PARTITION)
    @PartForField(value = "performedService_DPL_id")
    @Default(value = "0")
    public Long performedService_DPL_colocationKey;

    @DataType(value = TransformType.ROOT)
    @PartForField(value = "performedService_DPL_id")
    @Default(value = "0")
    public Long performedService_DPL_rootId;
