 ...
 import com.sbt.cdm.api.model.published.instance.PublishedSignatory;

 import ru.sbt.kmdtransform.TransformType.*;

 public class PublishedSignatoryBuilder implements ObjectBuilder {
     @Override public Object build(String line, TableInfo tableInfo) {
         PublishedSignatory r = new PublishedSignatory();
...
r.partition_DPL_id = DelimetedStringParser._long(11, line, indexes);
     ...
     @Override public int compare(Object first, Object second) {
         PublishedSignatory f = (PublishedSignatory)first;
         PublishedSignatory s = (PublishedSignatory)second;
