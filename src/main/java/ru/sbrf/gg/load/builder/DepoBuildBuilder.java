 ...
 import com.sbt.cdm.model.extension.deposit.DepoBuild;

 import ru.sbt.kmdtransform.TransformType.*;

 public class DepoBuildBuilder implements ObjectBuilder {
     @Override public Object build(String line, TableInfo tableInfo) {
         DepoBuild r = new DepoBuild();
...
r.datePact = DelimetedStringParser.date(5, line, indexes);
...
r.productParty_DPL_id = DelimetedStringParser._long(11, line, indexes);
r.category_DPL_id = DelimetedStringParser._long(12, line, indexes);
r.partition_DPL_id = DelimetedStringParser._long(13, line, indexes);

         return r;
     }

     @Override public int compare(Object first, Object second) {
         DepoBuild f = (DepoBuild)first;
         DepoBuild s = (DepoBuild)second;
...
if (CompareUtils.compare(f.datePact, s.datePact) != 0) return CompareUtils.compare(f.datePact, s.datePact);
